...
async function summarizeConversation(convo, callerPhoneNumber, tradie) {
  ...
  - reminderLocation: Location (lat, long) of the reminder if the user is setting a reminder and mentioned a location if not set it to null. You can get user's country through country code of the phone number that is (${callerPhoneNumber})
